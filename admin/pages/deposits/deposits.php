        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Recent Deposits </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="#">deposits</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Recent Deposits</li>
                </ol>
              </nav>
            </div>
            <div class="row ">
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="actionsDropdown">
                                        <li><a class="dropdown-item" href="edit_deposit.php?id=<?php echo $row['id']; ?>">Edit</a></li>
                                        <li><a class="dropdown-item" href="delete_deposit.php?id=<?php echo $row['id']; ?>">Delete</a></li>
                                        <?php
                                        if ($row['status'] == 1) {
          ...
          <!--    <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © Cotek Technologies 2024</span>-->

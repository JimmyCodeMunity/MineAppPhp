...
$select = "SELECT * FROM users WHERE email = '$admail'";
...
if(isset($_POST['submit'])) {
    ...
    $profit = $_POST['profit'];
    $coin = $_POST['coin'];
    $isFeatured = $_POST['isFeatured'] ? true : false;
    
    
    $query = "INSERT INTO plans(name, hourly_time, price, profit, coin, isFeatured) VALUES('$name', '$htime', '$price', '$profit', '$coin', '$isFeatured')";
    
    $res = mysqli_query($conn, $query);
    
    if($res) {
        echo "<script type='text/javascript'>alert('Plan Created Successfully!');</script>";
    }
}
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic3">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="#">Create Plan</a></li>
                <li class="nav-item"> <a class="nav-link" href="plans.php">View Plans</a></li>
                <!-- <li class="nav-item"> <a class="nav-link" href="pages/ui-features/dropdowns.html">Recent Withdrawals</a></li> -->
                <!-- <li class="nav-item"> <a class="nav-link" href="pages/ui-features/typography.html">Typography</a></li> -->
              </ul>
            </div>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="form-sample" method="post" action="">
                      <p class="card-description"> Plans </p>
                      <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Hourly Time</label>
                            <div class="col-sm-9">
                              <input type="number" class="form-control" name="htime" />
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Profit Per Period</label>
                            <div class="col-sm-9">
                      ...
                      <p class="card-description"> Coins </p>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Select Coin</label>
                            <div class="col-sm-9">
                              <select name="coin" class="form-control">
                                <option name="coin" value="BTC">BTC</option>
                                <option name="coin" value="USDT">USDT</option>
                              </select>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <!--<div class="col-sm-9">-->
                            <!--  <input type="text" name="isFeatured" class="form-control" />-->
                            <!--</div>-->
                            <div class="form-check">
                              <label class="form-check-label">
                                <input type="checkbox" class="form-check-input ml-3" name="isFeatured" checked> isFeatured? </label>
                            </div>
                          </div>
                        </div>
                        <input type="submit" class="form-control bg-warning" name="submit" />
                      </div>

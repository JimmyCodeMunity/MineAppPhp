...
if(isset($_POST['update'])) {
    ...
    $query = "UPDATE users SET name='$name', hourly_time='$htime', price='$price', profit='$profit', coin='$coin', isFeatured='$isFeatured' WHERE id = '$id'";
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="number" class="form-control" name="htime" value="<?php echo $row['hourly_time']?>" />
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="number" class="form-control" name="profit" value="<?php echo $row['profit']?>" />
                            </div>
                          </div>
                        </div>
                      </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <select name="coin" class="form-control">
                                <option name="coin" value="<?php echo $row['coin']?>"><?php echo $row['coin']?></option>
                          ...
                          <div class="form-group row">
                            <div class="form-check">
                              <!--<label class="form-check-label">-->
                                <input type="checkbox" class="form-check-input ml-3" name="isFeatured" checked> isFeatured?
                            </div>
                          </div>
                        </div>

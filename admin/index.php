        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="pages/deposits/deposits.php">Manage Deposits</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/withdrawals/withdrawals.php">Manage Withdrawals</a></li>
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic2">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="pages/users/users.php">Manage Users</a></li>

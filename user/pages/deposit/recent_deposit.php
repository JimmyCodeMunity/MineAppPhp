...
$select = "SELECT * FROM deposit WHERE useremail ='$useremail'";
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="deposit_request.php">Deposit request</a></li>
                <li class="nav-item"> <a class="nav-link" href="#">Recent Deposits</a></li>

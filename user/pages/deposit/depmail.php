...
function sendEmail($recipient_email, $user, $currency, $amount)
{
    $subject = 'Test Mailer';
...
';
        ...
        echo "<script type='text/javascript'>alert('Deposit request sent successfully. Once deposit is confirmed your account balance will be updated.')</script>";

...
$withdraw = "SELECT * FROM withdraws WHERE email = '$useremail'";
$withdraw_run = mysqli_query($conn,$withdraw);
$qty2= 0;
while ($num2 = mysqli_fetch_assoc ($withdraw_run)) {
    $qty2 += $num2['amount'];
}

echo "total:",$qty;
echo "total withdrawn:",$qty2;
$balance = $qty - $qty2;
$profit = (30/100)*($balance);
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic2">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="pages/withdraw/withdraw_request.php">Withdraw request</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/withdraw/recent_withdraw.php">Recent Withdrawals</a></li>
                <!-- <li class="nav-item"> <a class="nav-link" href="pages/ui-features/typography.html">Typography</a></li> -->
              </ul>
            </div>
          </li>
              ...
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h6 class="text-muted font-weight-normal">Total Coins</h6>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
              ...
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h6 class="text-muted font-weight-normal">Succesful Withdrawals</h6>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
